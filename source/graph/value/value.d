...
struct GraphValue {
	...
	@property size_t length() const {
		if (isArray) return value.get!Array.length;
		if (isObject) return value.get!Object.length;
		return 0;
	}
	...
	ref inout(GraphValue) opIndex(string key) inout
	{
